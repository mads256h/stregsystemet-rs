...
cssElement.href = "/static/themes/fireworks/fireworks.css";
...
rocketImg.id = "rocket";
rocketImg.src = "/static/themes/fireworks/rocket.png";
...
function updateCanvasSizes() {
  for (let canvas of canvases) {
    ...
    c.width = Math.max(body.clientWidth, window.innerWidth);
    c.height = Math.max(body.clientHeight, window.innerHeight);
